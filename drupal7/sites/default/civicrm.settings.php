...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/drupaldb?new_link=true');
}
...
$civicrm_root = 'C:/wamp/www/drupal7/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:/wamp/www/drupal7\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost:809/drupal7/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '7f70bf27b067284ca8de38587adcffb5');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:/wamp/www/drupal7\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
