...
function angularex_civicrm_install() {
  _angularex_civix_civicrm_install();
}
...
function angularex_civicrm_uninstall() {
  _angularex_civix_civicrm_uninstall();
}
...
function angularex_civicrm_enable() {
  _angularex_civix_civicrm_enable();
}
...
function angularex_civicrm_disable() {
  _angularex_civix_civicrm_disable();
}
...
function angularex_civicrm_managed(&$entities) {
  _angularex_civix_civicrm_managed($entities);
}
 ...
 * @link http://wiki.civicrm.org/confluence/display/CRMDOC/hook_civicrm_caseTypes
 */
function angularex_civicrm_angularModules(&$angularModules) {
_angularex_civix_civicrm_angularModules($angularModules);
}
 ...
 *
function angularex_civicrm_preProcess($formName, &$form) {
 ...
 *
function angularex_civicrm_navigationMenu(&$menu) {
  _angularex_civix_insert_navigation_menu($menu, NULL, array(
    'label' => ts('The Page', array('domain' => 'org.civicrm.angularex')),
    'name' => 'the_page',
  ...
  _angularex_civix_navigationMenu($menu);
} // */
